...
#		define INTERNAL_CATCH_TEMPLATE_UNIQUE_NAME(Name, ...)                                     \
			INTERNAL_CATCH_TEMPLATE_UNIQUE_NAME1(                                                  \
				Name, INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_REMOVE_PARENS(__VA_ARGS__)))
#	endif
...
#	define INTERNAL_CATCH_SECTION(...)                                                             \
		...
		if (Catch::Section const& INTERNAL_CATCH_UNIQUE_NAME(                                       \
				catch_internal_Section) = Catch::SectionInfo(CATCH_INTERNAL_LINEINFO, __VA_ARGS__)) \
...
public:	   // IResultCapture
	...
	void handleNonExpr(
		AssertionInfo const& info, ResultWas::OfType resultType, AssertionReaction& reaction) override;
...
IndexTracker::IndexTracker(
	NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* parent, int size)
