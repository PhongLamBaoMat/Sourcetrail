...
TEST_CASE("index javasymbolsolver 0 6 0 project")
{
	const std::vector<FilePath>& classpath = {
		FilePath(L"data/JavaIndexSampleProjectsTestSuite/JavaSymbolSolver060/lib/guava-21.0.jar")
			.makeAbsolute(),
		FilePath(
			L"data/JavaIndexSampleProjectsTestSuite/JavaSymbolSolver060/lib/"
			L"javaparser-core-3.3.0.jar")
			.makeAbsolute(),
		FilePath(L"data/JavaIndexSampleProjectsTestSuite/JavaSymbolSolver060/lib/javaslang-2.0.3.jar")
			.makeAbsolute(),
		FilePath(
			L"data/JavaIndexSampleProjectsTestSuite/JavaSymbolSolver060/lib/"
			...
			.makeAbsolute(),
		FilePath(
			L"data/JavaIndexSampleProjectsTestSuite/JavaSymbolSolver060/src/"
	...
	processSourceFiles(
		"JavaSymbolSolver060",
		{FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/"
			 L"SourceFileInfoExtractor.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/core/resolution/"
			 L"Context.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/core/resolution/"
			 L"ContextHelper.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/declarations/common/"
			 L"MethodDeclarationCommonLogic.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/javaparser/"
			 L"Navigator.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/javaparser/"
			 L"package-info.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/javaparsermodel/"
		 ...
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/javassistmodel/"
		 ...
		 FilePath(
			 ...
			 L"package-info.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/model/typesystem/"
			 L"LazyType.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/model/typesystem/"
			 L"ReferenceTypeImpl.java"),
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/reflectionmodel/"
		 ...
		 FilePath(
			 L"java-symbol-solver-core/com/github/javaparser/symbolsolver/resolution/"
		 ...
		 FilePath(
			 L"java-symbol-solver-logic/com/github/javaparser/symbolsolver/logic/"
		 ...
		 FilePath(
			 L"java-symbol-solver-model/com/github/javaparser/symbolsolver/model/declarations/"
			 L"AccessLevel.java"),
		 FilePath(
			 L"java-symbol-solver-model/com/github/javaparser/symbolsolver/model/declarations/"
		 ...
		 FilePath(
			 L"java-symbol-solver-model/com/github/javaparser/symbolsolver/model/methods/"
			 L"MethodUsage.java"),
		 FilePath(
			 L"java-symbol-solver-model/com/github/javaparser/symbolsolver/model/resolution/"
		 ...
		 FilePath(
			 ...
			 L"Value.java"),
		 FilePath(
			 L"java-symbol-solver-model/com/github/javaparser/symbolsolver/model/typesystem/"
			 L"ArrayType.java"),
		 FilePath(
			 L"java-symbol-solver-model/com/github/javaparser/symbolsolver/model/typesystem/"
