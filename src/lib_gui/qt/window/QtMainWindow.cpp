...
void QtMainWindow::showChangelog()
{
	QDesktopServices::openUrl(QUrl(
		QStringLiteral("https://github.com/PhongLamBaoMat/Sourcetrail/blob/main/CHANGELOG.md")));
}

void QtMainWindow::showBugtracker()
{
	QDesktopServices::openUrl(
		QUrl(QStringLiteral("https://github.com/PhongLamBaoMat/Sourcetrail/issues")));
}
