...
*__Important Note:__ This project was archived by the original autors and maintainers of Sourcetrail by the end of 2021. We forked the project to continue maintaining it.*
...
To setup Sourcetrail on your machine, you can either download the respective build for your operating system from our list of [Releases](https://github.com/PhongLamBaoMat/Sourcetrail/releases) and install it on your machine, or use one of the following package managers:

After your installation is complete, follow our [Quick Start Guide](DOCUMENTATION.en.md#getting-started) to get to know Sourcetrail.

## How to Report Issues

You can post all your feature requests and bug reports on our [issue tracker](https://github.com/PhongLamBaoMat/Sourcetrail/issues).
...
* Please read and follow the steps in [CONTRIBUTING.md](CONTRIBUTING.en.md) file.
* You may want to look out for issues labeled [good first issue](https://github.com/PhongLamBaoMat/Sourcetrail/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) to find some initial tasks to tackle.
...
* __LLVM/Clang 21.1.8__
    ...
    * __Building for MacOS__: Install LLVM via Homebrew `brew install llvm@21`
