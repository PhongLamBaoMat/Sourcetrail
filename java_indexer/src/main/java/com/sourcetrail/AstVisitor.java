...
public abstract class AstVisitor extends ASTVisitor {
    ...
    final private FileContent m_fileContent;
    final private CompilationUnit m_compilationUnit;
    final private Stack<List<SymbolName>> m_contextStack = new Stack<>();
    ...
    public AstVisitor(
        ...
        m_contextStack.push(Collections.singletonList(new FileName(filePath)));
    }
    ...
    public boolean visit(AnnotationTypeDeclaration node) {
        ...
        m_contextStack.push(Collections.singletonList(symbolName));
    ...
    public boolean visit(final ImportDeclaration node) {
        ...
        if (binding instanceof IPackageBinding) {
            ...
            packageName.ifPresent(declName -> m_client.recordSymbol(
    ...
    private List<ITypeBinding> getAllAncestorTypes(ITypeBinding type) {
        ...
        List<ITypeBinding> allAncestorTypes = new ArrayList<>(directAncestorTypes);
